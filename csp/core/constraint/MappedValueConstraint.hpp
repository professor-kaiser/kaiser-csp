#ifndef __KAISER_CORE_MAPPED_VALUE_CONSTRAINT_HPP__
#define __KAISER_CORE_MAPPED_VALUE_CONSTRAINT_HPP__
...
{
    class MappedValueConstraint : public Constraint
    {
    public:
    ...
    private:
        ...
        std::map<MappedValueConstraint::Operation, std::function<bool (int, int)>> compare = {
